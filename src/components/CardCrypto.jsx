...
const CardCrypto = ({ id, symbol, name, priceUSD, changePercent }) => {
    return (
        <div className={changePercent > 0 ? "bg-green-200 rounded-lg flex flex-col" : "bg-red-200 rounded-lg flex flex-col"}>
            ...
            <Link to={`/cryptomonedas/${id}`} className="mb-3 mx-3 py-3 px-4 bg-blue-500 text-white text-center rounded-md hover:bg-blue-400 duration-300">Más información</Link>
        </div>
    )
};
